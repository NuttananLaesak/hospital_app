...
class EditStrictly_Prohibited4 extends StatefulWidget {
  final ValueChanged<int> onChanged;
  final int patientId;

  const EditStrictly_Prohibited4(
      {Key? key, required this.onChanged, required this.patientId})
      : super(key: key);

  @override
  State<EditStrictly_Prohibited4> createState() =>
      _EditStrictly_Prohibited4State();
}

class _EditStrictly_Prohibited4State extends State<EditStrictly_Prohibited4> {
