...
class EditStrictly_Prohibited13 extends StatefulWidget {
  final ValueChanged<int> onChanged;
  final int patientId;

  const EditStrictly_Prohibited13(
      {Key? key, required this.onChanged, required this.patientId})
      : super(key: key);

  @override
  State<EditStrictly_Prohibited13> createState() =>
      _EditStrictly_Prohibited13State();
}

class _EditStrictly_Prohibited13State extends State<EditStrictly_Prohibited13> {
