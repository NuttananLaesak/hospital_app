...
class EditStrictlyNotProhibited5 extends StatefulWidget {
  final ValueChanged<int> onChanged;
  final int patientId;

  const EditStrictlyNotProhibited5(
      {Key? key, required this.onChanged, required this.patientId})
      : super(key: key);

  @override
  State<EditStrictlyNotProhibited5> createState() =>
      _EditStrictlyNotProhibited5State();
}

class _EditStrictlyNotProhibited5State
    extends State<EditStrictlyNotProhibited5> {
