...
import 'package:hospital_app/Quiz/quiz5_page.dart';
...
class _Question4PageState extends State<Question4Page> {
  ...
  void _selectAnswer(int score, String text) {
    final quiz = Provider.of<QuizModel>(context, listen: false);
    quiz.updateScore4(score, text);
    setState(() {
      selectedScore4 = score;
      selectedText4 = text;
    });
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => Question5Page(
            ...
            totalScore: widget.totalScore + selectedScore4,
          ),
        ),
      );
    }
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                bool isSelected = selectedScore4 == score;
