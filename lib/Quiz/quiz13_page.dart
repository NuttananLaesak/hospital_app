...
import 'package:hospital_app/Quiz/quiz14_page.dart';
...
class _Question13PageState extends State<Question13Page> {
  int selectedScore13 = -1;
  String selectedText13 = "";
  ...
  void _selectAnswer(int score, String text) {
    final quiz = Provider.of<QuizModel>(context, listen: false);
    quiz.updateScore13(score, text);
    setState(() {
      selectedScore13 = score;
      selectedText13 = text;
    });
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => Question14Page(
            ...
            totalScore: widget.totalScore + selectedScore13,
          ),
        ),
      );
    }
  ...
  void _showFullScreenImage() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            FullScreenImageViewer(imagePath: 'images/nihss9.jpg'),
      ),
    );
  }
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                bool isSelected = selectedScore13 == score;
