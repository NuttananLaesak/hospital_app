...
import 'package:hospital_app/Quiz/quiz9_page.dart';
...
class _Question8PageState extends State<Question8Page> {
  int selectedScore8 = -1;
  String selectedText8 = "";
  ...
  void _selectAnswer(int score, String text) {
    final quiz = Provider.of<QuizModel>(context, listen: false);
    quiz.updateScore8(score, text);
    setState(() {
      selectedScore8 = score;
      selectedText8 = text;
    });
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => Question9Page(
            ...
            totalScore: widget.totalScore + selectedScore8,
          ),
        ),
      );
    }
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                bool isSelected = selectedScore8 == score;
