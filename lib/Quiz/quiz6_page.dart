...
import 'package:hospital_app/Quiz/quiz7_page.dart';
...
class _Question6PageState extends State<Question6Page> {
  int selectedScore6 = -1;
  String selectedText6 = "";
  ...
  void _selectAnswer(int score, String text) {
    final quiz = Provider.of<QuizModel>(context, listen: false);
    quiz.updateScore6(score, text);
    setState(() {
      selectedScore6 = score;
      selectedText6 = text;
    });
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => Question7Page(
            ...
            totalScore: widget.totalScore + selectedScore6,
          ),
        ),
      );
    }
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                bool isSelected = selectedScore6 == score;
