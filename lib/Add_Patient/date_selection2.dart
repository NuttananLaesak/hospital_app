...
class DatetimeSelection2 extends StatefulWidget {
  final TextEditingController controller;
  final VoidCallback onDateChanged; // Add this line

  const DatetimeSelection2(
      {Key? key, required this.controller, required this.onDateChanged})
      : super(key: key);

  @override
  State<DatetimeSelection2> createState() => _DatetimeSelection2State();
}

class _DatetimeSelection2State extends State<DatetimeSelection2> {
