...
class EditNihss15 extends StatefulWidget {
  final int patientID;

  const EditNihss15({Key? key, required this.patientID}) : super(key: key);

  @override
  State<EditNihss15> createState() => _EditNihss15State();
}

class _EditNihss15State extends State<EditNihss15> {
  ...
  Future<void> _loadPatientData() async {
    ...
    if (result.isNotEmpty) {
      setState(() {
        _oldselectedScore = result.first['SelectedScore15'];
  ...
  Future<void> _updatePatientData(int score, String text) async {
    ...
    String updateQuery = "UPDATE Patient SET "
        "SelectedScore15 = $_selectedScore, "
        "SelectedText15 = '$_selectedText', "
