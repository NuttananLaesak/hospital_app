...
class EditNihss13 extends StatefulWidget {
  final int patientId;

  const EditNihss13({Key? key, required this.patientId}) : super(key: key);

  @override
  State<EditNihss13> createState() => _EditNihss13State();
}

class _EditNihss13State extends State<EditNihss13> {
  ...
  Future<void> loadPatientData() async {
    ...
    for (var patientData in patientList) {
      ...
      if (patient.id == widget.patientId) {
        setState(() {
          _patient = patient;
          _oldselectedScore = patient.selectedScore13;
  ...
  Future<void> _updatePatientData(int score, String text) async {
    ...
    final updatedPatient = Patient(
      ...
      selectedScore13: _selectedScore,
  ...
  Widget build(BuildContext context) {
    ...
    String questionText = "ข้อที่ 9 ความสามารถด้านภาษา\n(Best Language)";
    List<String> _questions = [
      "การสื่อสารเป็นปกติ",
      "การสื่อสารสูญเสียไป\nในระดับน้อยถึงปานกลาง",
      "การสื่อสารสูญเสียไปในระดับรุนเเรง",
      "ไม่พูด หรือมี Global Aphasia",
    ];
                          ...
                          children: [
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: Image.asset('images/nihss9.jpg',
