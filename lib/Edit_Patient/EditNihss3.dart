...
class EditNihss3 extends StatefulWidget {
  final int patientID;

  const EditNihss3({Key? key, required this.patientID}) : super(key: key);

  @override
  State<EditNihss3> createState() => _EditNihss3State();
}

class _EditNihss3State extends State<EditNihss3> {
  ...
  Future<void> _loadPatientData() async {
    ...
    if (result.isNotEmpty) {
      setState(() {
        _oldselectedScore = result.first['SelectedScore3'];
  ...
  Future<void> _updatePatientData(int score, String text) async {
    ...
    String updateQuery = "UPDATE Patient SET "
        "SelectedScore3 = $_selectedScore, "
        "SelectedText3 = '$_selectedText', "
