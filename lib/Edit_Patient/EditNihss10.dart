...
class EditNihss10 extends StatefulWidget {
  final int patientID;

  const EditNihss10({Key? key, required this.patientID}) : super(key: key);

  @override
  State<EditNihss10> createState() => _EditNihss10State();
}

class _EditNihss10State extends State<EditNihss10> {
  ...
  Future<void> _loadPatientData() async {
    ...
    if (result.isNotEmpty) {
      setState(() {
        _oldselectedScore = result.first['SelectedScore10'];
  ...
  Future<void> _updatePatientData(int score, String text) async {
    ...
    String updateQuery = "UPDATE Patient SET "
        "SelectedScore10 = $_selectedScore, "
        "SelectedText10 = '$_selectedText', "
