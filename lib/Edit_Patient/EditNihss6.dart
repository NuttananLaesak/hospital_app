...
class EditNihss6 extends StatefulWidget {
  final int patientID;

  const EditNihss6({Key? key, required this.patientID}) : super(key: key);

  @override
  State<EditNihss6> createState() => _EditNihss6State();
}

class _EditNihss6State extends State<EditNihss6> {
  ...
  Future<void> _loadPatientData() async {
    ...
    if (result.isNotEmpty) {
      setState(() {
        _oldselectedScore = result.first['SelectedScore6'];
  ...
  Future<void> _updatePatientData(int score, String text) async {
    ...
    String updateQuery = "UPDATE Patient SET "
        "SelectedScore6 = $_selectedScore, "
        "SelectedText6 = '$_selectedText', "
  ...
  Widget build(BuildContext context) {
    ...
    String questionText =
        "ข้อที่ 4 การเคลื่อนไหวของ\nกล้ามเนื้อใบหน้า (Facial Palsy)";
    List<String> _questions = [
      "ไม่พบอาการอ่อนเเรงของกล้ามเนื้อใบหน้า",
      "กล้ามเนื้อใบหน้าอ่อนเเรงเล็กน้อย",
      "กล้ามเนื้อใบหน้าอ่อนเเรงมาก",
      "ไม่สามารถเคลื่อนใหวกล้ามเนื้อใบหน้าได้"
    ];
