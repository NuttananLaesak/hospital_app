...
class EditNihss14 extends StatefulWidget {
  final int patientID;

  const EditNihss14({Key? key, required this.patientID}) : super(key: key);

  @override
  State<EditNihss14> createState() => _EditNihss14State();
}

class _EditNihss14State extends State<EditNihss14> {
  ...
  Future<void> _loadPatientData() async {
    ...
    if (result.isNotEmpty) {
      setState(() {
        _oldselectedScore = result.first['SelectedScore14'];
  ...
  Future<void> _updatePatientData(int score, String text) async {
    ...
    String updateQuery = "UPDATE Patient SET "
        "SelectedScore14 = $_selectedScore, "
        "SelectedText14 = '$_selectedText', "
